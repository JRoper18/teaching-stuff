 ...
 * util/       - It's inevitable //Note to Jack: What does this even mean?
...
Uses `gulp` to build itself. //Note to Jack: No it fucking doesn't. I have been here so ** long. Gulp DOES NOT WORK. RAAAAAGH
